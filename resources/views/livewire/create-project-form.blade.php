<div class="grid grid-cols-12 my-12">
    ...
    <form
        class="text-white flex flex-col gap-4 w-full col-span-12 sm:col-span-8 sm:col-start-3 sm:row-start-2 toBeCollapsed openCollapse"
        ...
        <div class="grid sm:grid-cols-12 gap-4">
            ...
            <div
                class=" col-span-2 flex items-center ps-4 border @if($category == '1') border-orange-500 @else border-[#33353F]  @endif bg-[#18191E] rounded">
                <input id="radio-fe" type="radio" value="1" name="bordered-radio" wire:model.blur="category"
                    class="@error('category') border-orange-700  @enderror w-4 h-4">
                <label for="radio-fe" class="w-full py-4 ms-2 text-sm font-medium text-white">Frontend</label>
            </div>
            <div
                class=" col-span-2 flex items-center ps-4 border  @if($category == '2') border-orange-500 @else border-[#33353F]  @endif rounded bg-[#18191E]">
